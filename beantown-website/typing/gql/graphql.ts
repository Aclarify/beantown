...
export type Memberships = Document & {
  ...
  logoMobile?: Maybe<ImageIcon>;
  name?: Maybe<Scalars['String']>;
  serviceMembershipsSection?: Maybe<Array<Maybe<ServiceMembership>>>;
};
...
export type RootQuery = {
  ...
  ServiceMembership?: Maybe<ServiceMembership>;
  ...
  allServiceMembership: Array<ServiceMembership>;
...
export type RootQueryServiceMembershipArgs = {
  id: Scalars['ID'];
};
...
export type RootQueryAllServiceMembershipArgs = {
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
  sort?: InputMaybe<Array<ServiceMembershipSorting>>;
  where?: InputMaybe<ServiceMembershipFilter>;
};
...
export type ServiceMembership = Document & {
  __typename?: 'ServiceMembership';
  /** Date the document was created */
  _createdAt?: Maybe<Scalars['DateTime']>;
  /** Document ID */
  _id?: Maybe<Scalars['ID']>;
...
export type ServiceMembershipFilter = {
  /** Apply filters on document level */
  _?: InputMaybe<Sanity_DocumentFilter>;
  _createdAt?: InputMaybe<DatetimeFilter>;
  _id?: InputMaybe<IdFilter>;
...
export type ServiceMembershipSorting = {
  _createdAt?: InputMaybe<SortOrder>;
  _id?: InputMaybe<SortOrder>;
  _key?: InputMaybe<SortOrder>;
  _rev?: InputMaybe<SortOrder>;
