...
const CONSTANTS = {
	...
	MISCELLANEOUS_MOBILE_DEVICE_SIGNATURES:
...
const useIsMobileDevice = (): boolean => {
	...
	useEffect(() => {
		if (typeof window !== 'undefined') {
			if (
				CONSTANTS.KNOWN_MOBILE_DEVICES.test(window.navigator.userAgent) ||
				CONSTANTS.MISCELLANEOUS_MOBILE_DEVICE_SIGNATURES.test(
