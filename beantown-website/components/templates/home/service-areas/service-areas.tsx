			...
			<div className="p-6 md:px-10">
				...
				<div className="relative pt-12 ">
					<Image
						...
						height="600"
					/>
					<div className="bg-[#FFFFFF] absolute inset-x-5 -bottom-64	md:inset-x-1/2 	md:inset-y-1/3  md:h-1/2 md:w-1/2  border rounded-lg   ">
						<div className="p-4">
							<h1 className="subtitle-6 md:subtitle-3 text-primary-black">
								{serviceAreas?.title}
							</h1>
						</div>
						<div className="grid grid-cols-2 justify-evenly mx-10 h-auto ">
							{serviceAreas?.listItem?.map((serviceArea, index) => {
								return (
									<div
										key={index}
										className="px-4 py-2  my-2 w-56 justify-center flex  space-x-2 bg-secondary-shade-3 para-6 md:para-2 rounded-md align-middle"
									>
										<img
