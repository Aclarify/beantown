...
export default function Services() {
	...
	return (
		...
		>
			<WaveWrapper shouldBePrefetched={true} waveURL={topWave}></WaveWrapper>
			<Image
				...
				<div className="flex flex-col items-center  pt-[4em] text-center lg:pt-0">
					<ContentWrapper>
						<ContentWrapper.Title>
							<Animate bottom>
								<h2 className="text-primary-black mb-4 px-10 sm:px-20">
									{servicesTitle}
								</h2>
							</Animate>
						</ContentWrapper.Title>
						<ContentWrapper.Description className="lg:px-50 px-10  sm:px-20 xl:px-80 ">
							<Animate>
