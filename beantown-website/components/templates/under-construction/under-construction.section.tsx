...
import UnderConstructionContent from './under-construction.content';
...
const UnderConstructionSection = () => {
	return (
		...
		>
			...
			/>
			<Image
				src={'/images/book-now/book-now-bottom-left-blob.svg'}
				height={590}
				width={650}
			...
			/>
			<Image
				src={'/images/book-now/book-now-bottom-left-blob-mobile.svg'}
				height={90}
				width={150}
			...
			/>
			<Image
				src={'/images/book-now/book-now-right-blob.svg'}
				height={590}
				width={650}
				alt="Right Blob "
			...
			/>
			<Image
				src={'/images/book-now/book-now-right-blob-mobile.svg'}
				height={90}
				width={150}
			...
			/>
			<Image
				src={'/images/book-now/book-now-bottom-blob.svg'}
				height={490}
				width={550}
				alt="Bottom Blob "
			...
			/>
			<Image
				src={'/images/book-now/book-now-bottom-blob-mobile.svg'}
				height={90}
				width={150}
